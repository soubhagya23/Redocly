  ...
  return (
    <div>
      ...
      <ReactSearchBox
        ...
        onSelect={(record) => {
          setSearchedData({
            APIName: record.item.value,
            APIDesc: record.item.desc,
          });
        }}
      />
      <br />
        ...
        searchedData?.APIName == null ? (
          searchedData?.APIName ? (
            ...
            <div>
              ...
              <p>
                Please click a Category of your choice on the left-hand side
                menu.Next, click on a product to view the related APIs.
              </p>
            </div>
          )
        ) : searchedData?.APIName ? (
          ...
          >
            <h2>Welcome to RBL's API Catalog1</h2>
            <br />
            <p>
              Please click a Category of your choice on the left-hand side
              menu.Next, click on a product to view the related APIs.
